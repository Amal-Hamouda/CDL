                ...
                <div class="row no-gutters justify-content-between">
                    <div class="col-auto d-flex align-items-center">
                        <div class="header-logo">
                            <a class="header-logo__link" href="<?php echo site_url("Home");?>"><img class="header-logo__img logo--light" src="<?php echo base_url();?>/resources/img/logo_white.png" alt="logo" style="visibility: hidden;"><img class="header-logo__img logo--dark" src="<?php echo base_url();?>/resources/img/Cultuel.png" alt="logo"></a>
                        </div>
                    </div>
                    <div class="col-auto">
                        <!-- main menu start-->
