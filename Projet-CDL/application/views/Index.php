                        ...
                        <nav>
                            <ul class="main-menu">
                                ...
                                <li id="participer" class="main-menu__item main-menu__item--has-child"><a class="main-menu__link" href="#Participer"><span
									class="button button--squared" href="#Participer" style="color:white;background-color: #e0c629;">Faire un don</span></a>

                                </li>
                                <li id="participer" class="main-menu__item main-menu__item--has-child"><a class="main-menu__link" href="#Participer"><span
									class="button button--squared" href="#Participer" style="color:white;background-color: #e0c629;">Adhésion</span></a>
